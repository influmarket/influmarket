...
app.get("/", (req, res) => {
  res.send(renderPage({
    ...
    buttonHref: "https://docs.google.com/forms/d/1ZOeHKWbkNz-WjMOHhwTbQRxkCFjhBLFUdaCKFCx66eI/viewform"
  }));
});
...
app.get("/apply/influencer", (req, res) => {
  res.send(renderPage({
    ...
    buttonHref: "https://docs.google.com/forms/d/11VXifpfSJ2SObzcgSZS_WiVLtrMIaU-WsIlehflO4eU/viewform"
  }));
});
...
app.get("/thank-you", (req, res) => {
  res.send(renderPage({
    ...
    subheading: "Check your inbox for a confirmation email.",
...
app.listen(PORT, () => console.log("influ.market running on port " + PORT));
